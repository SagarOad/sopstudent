    ...
    <div className="col-span-12 rounded-sm border border-stroke bg-white p-4 shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-4">
      <form action="#">
        <div className="p-2">
          ...
          <div className="mb-6 w-full xl:w-1/2">
            ...
            <div className="relative z-20 bg-transparent dark:bg-form-input">
              <select className="relative z-20 w-full appearance-none rounded border border-stroke bg-transparent py-3 px-5 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input dark:focus:border-primary">
                <option value="">Select Your Grade or Equivalent Grade</option>
          ...
          <button className="flex w-[50%] justify-center rounded bg-primary p-3 font-medium text-gray">
            Attach document of given certificate
          </button>
        </div>
        ...
        <div className="flex justify-end">
          ...
          <button
            ...
            className="flex w-[150px] justify-center rounded bg-red p-3 font-medium text-gray"
          >
            Close
          </button>
        </div>
